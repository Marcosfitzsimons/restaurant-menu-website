  ...
  return (
    <section className="relative grid w-full items-center pb-16 pt-6 after:absolute after:inset-0 after:z-10 after:bg-gradient-to-b after:from-transparent after:to-black/40">
      ...
      <div className="flex max-w-[980px] flex-col items-center gap-14">
        <div className="relative z-20 after:absolute after:pointer-events-none after:inset-px after:rounded-[7px] after:shadow-highlight after:shadow-white/30 after:transition focus-within:after:shadow-accent dark:after:shadow-highlight dark:focus-within:after:shadow-accent">

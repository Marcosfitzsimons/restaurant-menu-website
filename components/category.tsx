  ...
  return (
    <li className="flex flex-col items-center text-xs">
      <Link
        ...
        className={`relative rounded-full after:absolute after:pointer-events-none after:inset-px after:rounded-full after:shadow-highlight after:transition focus-within:after:shadow-accent transition-colors dark:after:shadow-highlight dark:focus-within:after:shadow-accent  ${
          pathname === `/${category.text.toLowerCase()}`
            ? "after:shadow-accent bg-accent/50 dark:after:shadow-accent"
            : "after:shadow-gray-300/20 bg-card hover:bg-accent/50 hover:after:shadow-accent dark:after:shadow-accent/20"
        }`}
      >
